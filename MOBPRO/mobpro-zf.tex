...
\section{Flashtalk - Grade Build System}
	...
	\subsection{Buildsysteme für Java}
	
	\begin{table}[!htb]
		\centering
		\begin{tabular}{|l|l|l|}
			\hline
			\textbf{Ant (2000)}& \textbf{Maven (2004)}& \textbf{Gradle (2007)}\\ \hline
			Deklarativ (XML)& Deklarativ (XML)& Deklarativ (DSL)\\ \hline
			Ant Tasks& Projektmodell (POM)&Projektmodell\\ \hline
			Kein Projektmodell         & Phases \& Goals                                                                               & Tasks \& Lifecycle                                                        \\ \hline
			Keine Konvention           & \begin{tabular}[c]{@{}l@{}}Konventionen:\\ - Projektstruktur\\ - Lifecyclephasen\end{tabular} & \begin{tabular}[c]{@{}l@{}}Konventionen:\\ - Projektstruktur\end{tabular} \\ \hline
			Kein Lifecycle             & Dependency Management                                                                         & Dependency Management                                                     \\ \hline
			Kein Dependency Management & Plugins                                                                                       & Plugins                                                                   \\\hline
			Kein Skripting             & Kein Skripting                                                                                & Skripting                                                                 \\ \hline
		\end{tabular}
		\caption{Übersicht der Build-Systeme für Java}
		\label{tab:buildsystems_java}
	\end{table}
...
\section{Nützliche Links}
	...
	\begin{itemize}
		...
		\item \textbf{Wikipedia | App Store (iOS)}\\
		\href{https://en.wikipedia.org/wiki/App_Store_\%28iOS\%29}
		{https://en.wikipedia.org/wiki/App\_Store\_\%28iOS\%29}
		
	\end{itemize}

	\subsection{Flashtalk - Gradle Build System}
	
	\begin{itemize}

		\item \textbf{Apache Groovy}\\
		\href{http://www.groovy-lang.org/}
		{http://www.groovy-lang.org/}
		
		\item \textbf{Gradle Build Tool}\\
		\href{https://gradle.org/}
		{https://gradle.org/}

	\end{itemize}

	\subsection{Flashtalk - Flutter}
